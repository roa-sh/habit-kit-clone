              ...
              <div className="flex items-start justify-between px-6 py-6">
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="flex-1 pt-1">
                    <h2 className="text-2xl font-bold text-ios-text-primary leading-tight">
                      {habit.name}
                    </h2>
                    {habit.description && (
                      <p className="text-sm text-ios-text-secondary mt-1.5 leading-relaxed">
                        {habit.description}
                      </p>
                    )}
                  </div>
              ...
              <div className="px-6 py-6 border-t border-ios-border bg-ios-bg/30">
                <div className="flex gap-6">
                  <div className="flex-1 text-center">
                    ...
                    <p className="text-3xl font-bold text-ios-text-primary">
                      {habit.currentStreak}
                    </p>
